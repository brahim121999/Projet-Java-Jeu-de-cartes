...
public class Player extends Utilisateur{
	...
	public void acheterCarte(Integer prix_propose, int id_joueur, rarete rar) {
		...
		for (Map.Entry mapentry : jeu.getListeEnVente().entrySet()) {
			...
			// carte appartenante à un autre joueur
				...
				System.out.println("Soit votre solde est insuffisant , soit le joueur recherché n'est pas à vendre");
			}
		}
