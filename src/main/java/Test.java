...
public class Test {
	...
	public void test() throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		Player player3 = new Player("joueur3", "0000", jeu);
		...
		admin.ajouterJoueur(jeu, "Aurélien Tchouamï¿½ni", true, france);
		...
		player3.acheterCarte(57);
		player3.acheterCarte(1057);
		player3.acheterCarte(2057);
		player3.acheterCarte(3057);
		...
		// Lancement d'une semaine de jeu d'une semaine
		...
		ArrayList<Integer> equipe_player3 = new ArrayList<Integer>();
		equipe_player3.add(57);
		equipe_player3.add(1057);
		equipe_player3.add(2057);
		equipe_player3.add(3057);
		player3.setCarteSemaineSuivante(equipe_player3);
